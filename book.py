...
book_title = popularity['Title'].tolist()
book_author = popularity['Author'].tolist()
total_ratings = popularity['num_rating'].tolist()
avg_ratings = popularity['avg_rating'].tolist()
